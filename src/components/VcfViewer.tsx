                ...
                <div style={S.head}>
                    <div style={S.headLeft}>
                        ...
                        <div>
                            ...
                            <div style={S.vcfMeta}>{loading ? 'Yuklanmoqda...' : `${variants?.length ?? 0} variant · qatorni bosib AI tahlil qiling`}</div>
                        </div>
                    </div>
                                ...
                                {variants.slice(0, expanded ? 1000 : 50).map((v, i) => {
                                    ...
                                    return (
                                        <tr
                                            ...
                                            title="AI bilan tahlil qilish uchun bosing"
                                        >
                                            {/* AI icon */}
                                            <td style={{ ...S.td, width: 28, textAlign: 'center', color: isSelected ? '#22d3ee' : '#1e293b' }}>
                                                🧬
                                            </td>
...
const S: Record<string, React.CSSProperties> = {
    ...
    trSelected: { background: 'rgba(14,165,233,.08)', outline: '1px solid rgba(14,165,233,.2)' },
    ...
    confBar: { height: 4, borderRadius: 2, flexShrink: 0 },
